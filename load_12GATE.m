...
if(isfile('12_GATE_EXAMPLE.mat'))
    load('12_GATE_EXAMPLE.mat')
else
    ...
    numOfGates     = 12; %number of NAND gates to start with, excludes the output gates
