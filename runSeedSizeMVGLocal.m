function [] = runSeedSizeMVGLocal(seed,mutProb,numOfGatesVec,onlyChangeConnections)
...
runSeedSizeOutputMVGLocal(seed,outputMat_1,outputMat_2,numOfInputs,numOfOutputs,numOfGates,numOfCandidateSolutions,mult,preDefinedSize,freqAlternate,L,mutProb,onlyChangeConnections)
end
