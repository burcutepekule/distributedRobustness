function [] = runSeedSizeLocal(seed,mutProb)
...
runSeedSizeOutputLocal(seed,outputMat,numOfInputs,numOfOutputs,numOfGates,numOfCandidateSolutions,mult,preDefinedSize,L,mutProb)
end
