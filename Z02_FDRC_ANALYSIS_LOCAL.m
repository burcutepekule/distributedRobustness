...
fileinfoRDC    = dir(['./local_output/AFTER_TOL_ALL_SEED_*.mat']);
...
for s=seedsConverged
    ...
    load(['./local_output/BEFORE_TOL_ALL_SEED_' num2str(s)])
    ...
    load(['./local_output/AFTER_TOL_ALL_SEED_' num2str(s)])
...
grid on;
saveas(h,['./local_output/FDRC_ANALYSIS.png'])
