...
for s=seedsConverged
    ...
    load(['./cluster_output/BEFORE_TOL_ALL_CONSTRAINT_SEED_' num2str(s)])
    ...
    load(['./cluster_output/AFTER_TOL_ALL_CONSTRAINT_SEED_' num2str(s)])
...
grid on;
saveas(h,['./cluster_output/FDRC_ANALYSIS_CONSTRAINT.png'])
