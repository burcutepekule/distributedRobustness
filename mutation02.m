...
while(any(backwardConnections) || condReconnect || isempty(connectedNode2Remove) || (isempty(renameMat) && isempty(connection2Reconnect)) || isempty(connectedNodes2Remove) || ~(isempty(diffNodes2Connect) || ~isempty(connectedNodes2Remove)))
