...
if(isfile(['AFTER_TOL_ALL_SEED_' num2str(seed) '.mat']))
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% FOR OPTION 0 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    [degeneracy,degeneracy2,degeneracyUB,redundancy,complexity,circuitSize] = calculateDegeneracyOption(keepOutput,keepAllOutput,numOfInputs,numOfOutputs,fittestStructure,0);
    keepData_0 = [keepData_0; simIdx circuitSize fitness ...
        faultTolerance degeneracy degeneracy2 degeneracyUB ...
        redundancy complexity];
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% FOR OPTION 1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    [degeneracy,degeneracy2,degeneracyUB,redundancy,complexity,circuitSize] = calculateDegeneracyOption(keepOutput,keepAllOutput,numOfInputs,numOfOutputs,fittestStructure,1);
