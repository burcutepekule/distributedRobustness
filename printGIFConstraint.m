function [] = printGIFConstraint(totalNum,fitnessVals,toleranceVals,degeneracyVals,complexityVals,redundancyVals,circuitSizeVals,lastIdx,seed)

filename = ['./cluster_output/circuitsAnimated_CONSTRAINT_SEED_' num2str(seed) '.gif'] ;
