...
fileinfoRDC    = dir(['./cluster_output/BEFORE_TOL_FITTEST_CIRCUIT_SIZE_SEED_*.mat']);
...
for seed = seedsConverged
    fileinfoBefore = dir(['./cluster_output/BEFORE_TOL_FITTEST_CIRCUIT_SIZE_SEED_' num2str(seed) '_*.mat']);
    allNames       = {fileinfoRDC.name};
...
for seed = seedPick
    ...
    load(['./cluster_output/BEFORE_TOL_FITTEST_CIRCUIT_SIZE_SEED_' num2str(seed) '_' num2str(totalNumVecSorted(seedSorted==seed)) '.mat']);
