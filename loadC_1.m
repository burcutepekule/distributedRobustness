...
fittestTextCircuit{5,2} = 1033;
fittestTextCircuit{6,2} = 1043;
fittestTextCircuit{7,2} = 2013;
fittestTextCircuit{8,2} = 2023;


fittestTextCircuit{1,3} = [1011,1021,1031,1041];
fittestTextCircuit{2,3} = [1012,1022,1032,1042];
fittestTextCircuit{3,3} = [2011];
fittestTextCircuit{4,3} = [2012];
fittestTextCircuit{5,3} = [2021];
fittestTextCircuit{6,3} = [2022];
fittestTextCircuit{7,3} = [3011,3021];
fittestTextCircuit{8,3} = [3012,3022];


fittestStructure = [0 2;1 4;2 2;3 2];
