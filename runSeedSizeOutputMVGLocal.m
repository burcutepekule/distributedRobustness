function [] = runSeedSizeOutputMVGLocal(seed,outputMat_1,outputMat_2,numOfInputs,numOfOutputs,numOfGates,numOfCandidateSolutions,mult,preDefinedSize,freqAlternate,L,mutProb,onlyChangeConnections)
...
minFitness                  = min(fitness,[],2); % min fitness
...
% fittestCircuitIdxOne = sortedIndex(sortedFitness==1);
% if(length(fittestCircuitIdxOne)>L)
%     fittestCircuitIdx = fittestCircuitIdxOne;
% else
...
minFitnessKeep              = [minFitnessKeep minFitness];
...
if(mutProb==0)
    save(['/Users/burcu/Dropbox/blogs/smallscaled/distributedRobustness/local_output/BEFORE_TOL_FITTEST_CIRCUIT_SIZE_MVG_SEED_' num2str(seed) '_' num2str(sim) '.mat'])
else
    save(['/Users/burcu/Dropbox/blogs/smallscaled/distributedRobustness/local_output/BEFORE_TOL_FITTEST_CIRCUIT_SIZE_MVG_MUT_SEED_' num2str(seed) '_' num2str(sim) '.mat'])
end
...
save(['/Users/burcu/Dropbox/blogs/smallscaled/distributedRobustness/local_output/BEFORE_TOL_ALL_SIZE_MVG_SEED_' num2str(seed) '.mat'])
